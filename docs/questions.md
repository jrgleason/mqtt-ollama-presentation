...
See also: voice-gateway-architecture.md (final voice stack), network-dependencies.md (what needs internet), outline.md (presentation flow).

---

## 📝 Implementation Inputs (kept succinct)

- Q3. Database Schema: Start minimal and expand as needed. Initial tables: Users (optional if Auth disabled), Devices (mqttTopic, room, type), UserPreferences. ConversationHistory can be a stretch goal.
