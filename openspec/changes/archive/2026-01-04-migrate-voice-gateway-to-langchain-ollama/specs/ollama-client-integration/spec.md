<<<<<<<< HEAD:openspec/specs/ollama-client-integration/spec.md
# ollama-client-integration Specification
========
# ollama-client-integration Spec Delta

## ADDED Requirements
>>>>>>>> origin/main:openspec/changes/archive/2026-01-04-migrate-voice-gateway-to-langchain-ollama/specs/ollama-client-integration/spec.md

## Purpose
TBD - created by archiving change migrate-voice-gateway-to-langchain-ollama. Update Purpose after archive.
## Requirements
