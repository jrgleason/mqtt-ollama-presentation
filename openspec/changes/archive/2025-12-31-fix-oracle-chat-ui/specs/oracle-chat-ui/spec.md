# Capability: Oracle Chat UI

## Overview

The Oracle chat interface provides a web-based conversation UI for interacting with the AI assistant. Users can send text messages, view AI responses with tool execution context, and see formatted content including markdown.
...
None - no existing requirements are being deprecated.
