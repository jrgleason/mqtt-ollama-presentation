...
**Pass Criteria**:
- [ ] Startup completes in 4-5 seconds
- [ ] Only ONE "✅ Detector warm-up complete" log (not two)
- [ ] Ready-to-listen beep plays after welcome message
- [ ] Wake word detected within 100ms of beep ending
- [ ] No "Detector reset (post-startup-tts)" log
